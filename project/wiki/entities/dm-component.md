...
The original plan (`project/raw/plan-dungeonMasterMode.prompt.md`) put all DM functionality into a single component. The graph confirms this: DmComponent directly owns quest creation, quest results, encounter management, saved quests, NPC creation, NPC results, NPC stats, and saved NPCs — 48 edges.
