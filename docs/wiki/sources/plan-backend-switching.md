...
raw: docs/raw/plan-llmBackendSwitching.prompt.md
ingested: 2026-04-23
---

# Source: LLM Backend Switching Plan

Summary of `docs/raw/plan-llmBackendSwitching.prompt.md` — the design spec for runtime LLM backend selection.
